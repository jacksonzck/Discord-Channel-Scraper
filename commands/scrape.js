...
module.exports = {
    ...
    .setDescription("Scrapes the channel, and outputs it into a JSON file into the bot's directory")
    ...
    async execute(interaction) {
        ...
        new_messages = await API.getMessages(interaction.channelId, {before: interaction.channel.lastMessageId, limit: 100})
